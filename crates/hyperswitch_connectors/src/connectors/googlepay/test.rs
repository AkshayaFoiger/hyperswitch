...
#[derive(Clone, Copy)]
struct GooglepayTest;
impl ConnectorActions for GooglepayTest {}
impl utils::Connector for GooglepayTest {
    fn get_data(&self) -> api::ConnectorData {
        use router::connector::Googlepay;
        api::ConnectorData {
            connector: Box::new(Googlepay::new()),
            connector_name: types::Connector::Googlepay,
...
static CONNECTOR: GooglepayTest = GooglepayTest {};
